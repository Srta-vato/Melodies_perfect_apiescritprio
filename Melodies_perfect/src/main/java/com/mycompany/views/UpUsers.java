...
public class UpUsers extends javax.swing.JPanel {
    ...
    private void InitStyles() {
        ...
        if (isEdition) {
            ...
            if (userEdition != null) {
                ...
                apPTxt.setText(userEdition.getApellido());
                apMTxt.setText(userEdition.getCorrreo());
                domTxt.setText(userEdition.getDireccion());
                phoneTxt.setText(userEdition.getTelefono());
            }
        }
    }
    ...
    private void initComponents() {
        ...
        apMLbl.setText("Correo");

        jSeparator1.setForeground(new java.awt.Color(204, 204, 204));
        jSeparator1.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jSeparator1.setPreferredSize(new java.awt.Dimension(200, 10));

        domLbl.setText("Direccion");
    ...
    private void buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionPerformed
       String nombre = nameTxt.getText();
        String apellido = apPTxt.getText();
        String correo = apMTxt.getText();
        String dir = domTxt.getText();
        String tel = phoneTxt.getText();

        // Validaciones para los campos
        if (nombre.isEmpty() || apellido.isEmpty() || correo.isEmpty() || dir.isEmpty() || tel.isEmpty()) {
