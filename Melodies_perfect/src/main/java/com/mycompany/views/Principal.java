...
public class Principal extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/logo.png"))); // NOI18N

        title.setText("Bienvenido");

        jLabel2.setText("Tienda de alquiler y venta de instrumentos musicales");

        jLabel3.setText("a precios increibles y de exelente calidad");

        jLabel4.setText("Este programa te permitira acceder a esos productos de manera rapido");

        jLabel5.setText("Aqui podras encontrar sesiones como:");

        jLabel6.setText("• Instrumento de cuerda");

        jLabel7.setText("• Instrumentos de percusion");

        jLabel8.setText("• Instrumentos de viento ");

        jLabel9.setText("• Instrumentos eletricos");

        jLabel10.setText("• Formas de contactarnos");

        jLabel11.setText("• Tus compras");
